                ...
                <div class="card-header">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="form-group">
                            <a href='categories_create'><button type="button" class="btn mb-1 btn-primary btn-lg btn-block waves-effect waves-light float-right">Add a Subcategories</button></a>
                        </div>
                    </div>
                </div>
